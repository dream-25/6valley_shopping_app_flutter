...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  void _loadData(BuildContext context, String type) async {
    ...
    Provider.of<OrderProvider>(context, listen: false).initOrderStatusList(context, Provider.of<SplashProvider>(context, listen: false).configModel.shippingMethod == 'inhouse_shipping' ?  'inhouse_shipping':"seller_wise");
              ...
              children: [
                ...
                Container(margin: EdgeInsets.only(left: 5, right: 5,),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text('${getTranslated('city', context)} : '
                        '${widget.orderModel.customer != null?
                    widget.orderModel.billingAddressData != null ? widget.orderModel.billingAddressData.city : '' : ''}',
                        style: titilliumRegular.copyWith(color: ColorResources.getTextColor(context))),
