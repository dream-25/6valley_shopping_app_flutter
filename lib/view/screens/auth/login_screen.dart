...
import 'package:sixvalley_vendor_app/view/screens/auth/signup_auth_screen.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              InkWell(
                onTap: () => Get.to(SignupAuthScreen()),
                child: Text(
                    getTranslated('Dont_have_a_account_SIGNUP', context),
                    style: robotoRegular.copyWith(
                        color: Theme.of(context).primaryColor)),
              ),
            ],
